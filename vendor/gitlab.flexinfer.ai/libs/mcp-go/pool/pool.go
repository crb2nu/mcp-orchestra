// Package pool provides connection pooling for MCP server clients.
//
// It manages a pool of connections to MCP servers, with features like:
...
//	        return mcp.DialStdio(ctx, "/path/to/server")
//	    },
//	})
//	defer pool.Close()
//
...
// Discard marks a connection as unhealthy and removes it from the pool.
